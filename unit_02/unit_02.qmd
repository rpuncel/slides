...
- A famous theorem is the \textbf{Central Limit Theorem} . Many of our statistical tests depend on this theorem, and it tells us when certain distributions will approach a normal distribution
...
\begin{tabular}{c|ccc}
    ...
    \end{tabular}
\pause% \alex{Does 2U course services have a nice 3d set of axes with a% transparent background?}![](figures/joint_axes.pdf)
...
- ![](figures/non-independent_rv.pdf)
:::
